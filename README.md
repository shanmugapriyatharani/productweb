    ...
    <body>
        <div class="home">
            <div class="header">
                ...
                Copyright &copy;2023 Developed by shanmugapriya</footer></div>
            </div>
        </div>
    </body>
</html>
...
<html lang="en">
    <head>
        ...
        .ceoph{
            background-image: url(/static/images/shanma.jpg);
            background-size: 250px;
            background-position-x: center;
            background-repeat: no-repeat;
        ...
        .manph2{
            background-image: url(/static/images/rifna.jpg);
            background-size: 250px;
            background-position-x: center;
            background-repeat: no-repeat;
            border:1px solid black;
        ...
        .amph1{
            background-image: url(/static/images/mouli.jpg);
            background-size: 250px;
            background-position-x: center;
            background-repeat: no-repeat;
            border:1px solid black;
        ...
        <div class="home">
            <div class="header">
                ...
                <div class="content">
                    ...
                    <div class="ceoph"></div>
                    <div class="ceo"><p align="center"><b><h2>shanmugapriya</h2></b></div>
                    <br>
                    <div class="text">
                    ...
                    <div class="man2"><p><b><h2>rifna</h2></b></p></div>
                    <br>
                    <div class="text"><p><b><u>Managers</u></b></p></div><br>
                    <div class="amph1"></div>
                    <div class="am1"><p align="center"><b><h2>mouli</h2></b></p></div>
                    <div class="amph2"></div>
                    <div class="am2"><p align="center"><b><h2>shreyas</h2></b></p></div>
                    <div class="amph3"></div>
                    <div class="am3"><p align="center"><b><h2>sharavanan</h2></b></p></div><br>
        ...
        <div class="home">
            <div class="header">
                ...
                <div class="content">
                    ...
                    <ul>
                        <li><b>Landline:</b> 123456789</li>
                        <li><b>Mobile</b>: 9345496759</li>
